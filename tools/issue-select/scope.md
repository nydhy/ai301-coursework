...
I have real experience in Python and Go. I want to get better at Python specifically, so I'd rather prioritize Python issues over other languages when several are otherwise equally good. I'm not interested in frontend work (UI/CSS/JS-heavy issues) and would rather avoid those if a backend or tooling alternative is available.
